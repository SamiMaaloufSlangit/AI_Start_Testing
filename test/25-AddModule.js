...
describe('Add Module', function () {
    ...
    it('successfully add module', async function () {
        try {
            ...
            console.log('🔍 Looking for "Add module" button');
            console.log('⏳ Waiting for "Add module" button to appear');
            await driver.wait(until.elementLocated(By.xpath("//button[contains(@class, 'bg-primary') and contains(@class, 'text-primary-foreground') and contains(@class, 'hover:bg-primary/90') and contains(., 'Add module')]")), 10000);
            console.log('  - "Add module" button found');

            console.log('🔘 Clicking "Add module" button');
            const addModuleButton = await driver.findElement(By.xpath("//button[contains(@class, 'bg-primary') and contains(@class, 'text-primary-foreground') and contains(@class, 'hover:bg-primary/90') and contains(., 'Add module')]"));
            ...
            await driver.wait(until.elementLocated(By.xpath("//button[@type='submit' and contains(@class, 'bg-primary') and contains(@class, 'text-primary-foreground') and text()='Save']")), 10000);
            console.log('  - "Save" button found');

            console.log('🔘 Clicking "Save" button');
            const saveButton = await driver.findElement(By.xpath("//button[@type='submit' and contains(@class, 'bg-primary') and contains(@class, 'text-primary-foreground') and text()='Save']"));
