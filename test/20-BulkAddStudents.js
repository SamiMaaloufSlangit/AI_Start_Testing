...
console.log('🚀 Starting Bulk Add Students Web Test');
console.log('📋 Test Configuration: Students');

describe('Bulk Add Students', function () {
    ...
    it('successfully bulk add students', async function () {
        try {
            ...
            console.log('📁 Looking for students.csv file');
            ...
            if (studentsExists) {
                ...
                throw new Error('students.csv file not found. Please add students.csv to the project root for bulk adding students.');
            }

            console.log('📁 Uploading students CSV file');
            await csvFileInput.sendKeys(csvFilePath);
            console.log('  - Students CSV file uploaded:', csvFilePath);
            ...
            console.log('🔼 Clicking Import button for students');
            await importButton.click();
            console.log('  - Import button clicked for students');

            console.log('⏳ Waiting for "Students imported" or "Users imported" notification');
            await driver.wait(until.elementLocated(By.xpath("//div[contains(@class, 'text-sm') and contains(@class, 'font-semibold') and (text()='Students imported' or text()='Users imported')]")), 15000);
            const notification = await driver.findElement(By.xpath("//div[contains(@class, 'text-sm') and contains(@class, 'font-semibold') and (text()='Students imported' or text()='Users imported')]"));
            console.log('  - Students import notification confirmed');

            await driver.sleep(2000);

            console.log('✅ Bulk Add Students Only test completed successfully');
