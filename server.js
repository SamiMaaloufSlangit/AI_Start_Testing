...
const testScripts = {
    ...
    'change-password': { name: 'Change Password Test', script: '04-changePassword', file: 'ChangePasswordReport.html' },
    'course-search': { name: 'Course Search Test', script: '05-courseSearch', file: 'CourseSearchReport.html' },
    'create-delete-course': { name: 'Create and Delete Course Test', script: '06-createDeleteCourse', file: 'CreateDeleteCourseReport.html' },
    'course-enroll-leave': { name: 'Course Enroll and Leave Test', script: '07-courseEnrollLeave', file: 'CourseEnrollLeaveReport.html' },
    'add-notes': { name: 'Add Notes Test', script: '08-AddNotes', file: 'AddNotesReport.html' },
    'ai-notes-summary-download': { name: 'AI Notes Summary & Download Test', script: '09-aiNotesSummaryDownload', file: 'AiNotesSummaryDownloadReport.html' },
    'chat-course': { name: 'Chat Course Test', script: '10-ChatCourse', file: 'ChatCourseReport.html' },
    'mark-complete': { name: 'Mark Complete Test', script: '11-markComplete', file: 'MarkCompleteReport.html' },
    'enrolled-course-nb': { name: 'Enrolled Course Count Test', script: '12-EnrolledCourseNB', file: 'EnrolledCourseNBReport.html' },
    'add-teacher': { name: 'Add Teacher Test', script: '13-AddTeacher', file: 'AddTeacherReport.html' },
    'edit-delete-teacher': { name: 'Edit and Delete Teacher Test', script: '14-EditDeleteTeacher', file: 'EditDeleteTeacherReport.html' },
    'export-teachers': { name: 'Export Teachers Test', script: '15-ExportTeachers', file: 'ExportTeachersReport.html' },
    'bulk-add-teachers': { name: 'Bulk Add Teachers Test', script: '16-BulkAddTeacher', file: 'BulkAddTeachersReport.html' },
    'search-filter-teachers': { name: 'Search & Filter Teachers Test', script: '17-SearchFilterTeachers', file: 'SearchFilterTeachersReport.html' },
    'resources': { name: 'Resources Test', script: '18-Resources', file: 'ResourcesReport.html' },
    'add-student': { name: 'Add Student Test', script: '19-AddStudent', file: 'AddStudentReport.html' },
    'edit-delete-student': { name: 'Edit and Delete Student Test', script: '20-EditDeleteStudent', file: 'EditDeleteStudentReport.html' },
    'bulk-add-students': { name: 'Bulk Add Students Test', script: '21-BulkAddStudents', file: 'BulkAddStudentsReport.html' },
    'view-all-courses-student': { name: 'View All Courses Student Test', script: '22-ViewAllCoursesStudent', file: 'ViewAllCoursesStudentReport.html' },
    'upload-content-bulk': { name: 'Upload Content Bulk Test', script: '23-UploadContentBulk', file: 'UploadContentBulkReport.html' },
    'add-lesson': { name: 'Add Lesson Test', script: '24-AddLesson', file: 'AddLessonReport.html' },
    'edit-lesson': { name: 'Edit Lesson Test', script: '25-EditLesson', file: 'EditLessonReport.html' },
    'add-model': { name: 'Add Model Test', script: '26-AddModel', file: 'AddModelReport.html' },
    'delete-model': { name: 'Delete Model Test', script: '27-DeleteModel', file: 'DeleteModelReport.html' },
    'course-clone': { name: 'Course Clone Test', script: '28-CourseClone', file: 'CourseCloneReport.html' }
};
